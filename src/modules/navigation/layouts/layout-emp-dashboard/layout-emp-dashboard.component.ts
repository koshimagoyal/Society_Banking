...
import { empSideNavItems, empSideNavSections } from '@modules/navigation/data/emp-side-nav.data';
...
export class LayoutEmpDashboardComponent implements OnInit, OnDestroy {
    ...
    sideNavItems = empSideNavItems;
    sideNavSections = empSideNavSections;
