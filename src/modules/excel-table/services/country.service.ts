...
function matches(country: Country, term: string, pipe: PipeTransform) {
    return (
        ...
        country.particulars.toLowerCase().includes(term.toLowerCase()) ||
        pipe.transform(country.withdrawal).includes(term) ||
        pipe.transform(country.deposit).includes(term) ||
        pipe.transform(country.balance).includes(term)
    );
}
*/
...
export class CountryService {
    ...
    public data = [[, ],[, ]];
    // public datas = new BehaviorSubject<AOA>([[,], [,]]);
